 ...
 * [AchievementsFragment.OnAchievementsFragmentInteractionListener] interface
...
class AchievementsFragment : Fragment() {
    ...
    private var listener: OnAchievementsFragmentInteractionListener? = null
    ...
    fun onButtonPressed(uri: Uri) {
        listener?.onAchievementsFragmentInteraction(uri)
    }

    override fun onAttach(context: Context) {
        super.onAttach(context)
        if (context is OnAchievementsFragmentInteractionListener) {
            listener = context
        } else {
